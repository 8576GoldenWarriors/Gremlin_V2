...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystickOp.leftBumper().onTrue(new MoveArmUp(m_arm, -0.5));
    joystickOp.rightBumper().onTrue(new MoveArmDown(m_arm, 0.5));
    joystickOp.a().onTrue(new ToggleClaw(m_claw, 0.2));
    joystickOp.b().onTrue(new ToggleClaw(m_claw, -0.2));
    joystickOp.y().onTrue(new ToggleClaw(m_claw, -0.75));
    joystickOp.x().onTrue(new ToggleClaw(m_claw, -0.65));
  }
